...
const _hoisted_50 = /* @__PURE__ */ createBaseVNode("p", null, [
  /* @__PURE__ */ createTextVNode("If one "),
  /* @__PURE__ */ createBaseVNode("code", null, "<box>"),
  /* @__PURE__ */ createTextVNode(" value is present then it sets both background-origin and background-clip to that value. If two values are present, then the first sets background-origin and the second background-clip.")
], -1);
const _hoisted_51 = /* @__PURE__ */ createTextVNode("\u2013\u2013\u2013\u2013 ");
const _hoisted_52 = {
  href: "https://www.w3.org/TR/2020/CR-css-backgrounds-3-20201222/#background",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_53 = /* @__PURE__ */ createTextVNode("CSS Backgrounds and Borders Module Level 3 - background");
const _hoisted_54 = /* @__PURE__ */ createStaticVNode('<p>\u987A\u5E8F\u5E76\u975E\u56FA\u5B9A, \u4F46\u662F\u8981\u6CE8\u610F:</p><ul><li><code>background-position</code>\u548C<code>background-size</code>\u5C5E\u6027\uFF0C\u4E4B\u95F4\u9700\u4F7F\u7528<code>/</code>\u5206\u9694\uFF0C\u4E14<code>background-position</code>\u503C\u5728\u524D\uFF0C<code>background-size</code>\u503C\u5728\u540E\u3002</li><li>\u5982\u679C\u540C\u65F6\u4F7F\u7528<code>background-origin</code>\u548C<code>background-clip</code>\u5C5E\u6027, <code>origin</code>\u5C5E\u6027\u503C\u9700\u5728<code>clip</code>\u5C5E\u6027\u503C\u4E4B\u524D, \u5982\u679C<code>origin</code>\u4E0E<code>clip</code>\u5C5E\u6027\u503C\u76F8\u540C, \u5219\u53EF\u53EA\u8BBE\u7F6E\u4E00\u4E2A\u503C\u3002</li></ul><p>\u9700\u8981\u6CE8\u610F\u7684\u662F\uFF0C\u5BF9\u4E8E CSS \u9884\u5904\u7406\u5668\u6765\u8BF4\uFF0C\u5F53\u5728\u7F29\u5199\u91CC\u540C\u65F6\u4F7F\u7528<code>background-position</code>\u548C<code>background-size</code>\u65F6\uFF0C\u4E2D\u95F4\u7684<code>/</code>\u4F1A\u88AB\u5F53\u6210\u9664\u53F7\u5BF9\u5F85\uFF0C\u5F85\u627E\u51FA\u89E3\u51B3\u529E\u6CD5\u3002</p><h3 id="animation" tabindex="-1"><a class="header-anchor" href="#animation" aria-hidden="true">#</a> animation</h3><p><code>animation</code>\u7B80\u5199\u987A\u5E8F\uFF1A</p><div class="language-css ext-css line-numbers-mode"><pre class="language-css"><code>&lt;single-animation&gt; =\n    &lt;time&gt; ||\n    &lt;timing-function&gt; ||\n    &lt;time&gt; ||\n    &lt;single-animation-iteration-count&gt; ||\n    &lt;single-animation-direction&gt; ||\n    &lt;single-animation-fill-mode&gt; ||\n    &lt;single-animation-play-state&gt; ||\n    [ none | &lt;keyframes-name&gt; ]\n</code></pre><div class="line-numbers"><span class="line-number">1</span><br><span class="line-number">2</span><br><span class="line-number">3</span><br><span class="line-number">4</span><br><span class="line-number">5</span><br><span class="line-number">6</span><br><span class="line-number">7</span><br><span class="line-number">8</span><br><span class="line-number">9</span><br></div></div>', 6);
const _hoisted_60 = /* @__PURE__ */ createStaticVNode("<p>Note that order is important within each animation definition: the first value in each <code>&lt;animation&gt;</code> that can be parsed as a <code>&lt;time&gt;</code> is assigned to the <code>animation-duration</code>, and the second value in each <code>&lt;animation&gt;</code> that can be parsed as a <code>&lt;time&gt;</code> is assigned to <code>animation-delay</code>.</p><p>Note that order is also important within each animation definition for distinguishing <code>&lt;keyframes-name&gt;</code> values from other keywords. When parsing, keywords that are valid for properties other than animation-name whose values were not found earlier in the shorthand must be accepted for those properties rather than for animation-name. Furthermore, when serializing, default values of other properties must be output in at least the cases necessary to distinguish an animation-name that could be a value of another property, and may be output in additional cases.</p>", 2);
const _hoisted_62 = /* @__PURE__ */ createTextVNode("\u2013\u2013\u2013\u2013 ");
const _hoisted_63 = {
  href: "https://www.w3.org/TR/css-animations-1/#animation",
  target: "_blank",
  rel: "noopener noreferrer"
};
const _hoisted_64 = /* @__PURE__ */ createTextVNode("CSS Animations Level 1 - animation");
    ...
    createBaseVNode("nav", _hoisted_2, [
      createBaseVNode("ul", null, [
        createBaseVNode("li", null, [
          createVNode(_component_RouterLink, { to: "#\u5C5E\u6027\u95F4\u987A\u5E8F" }, {
            default: withCtx(() => [
              _hoisted_3
            ]),
            _: 1
          ...
          createBaseVNode("ul", null, [
            createBaseVNode("li", null, [
              createVNode(_component_RouterLink, { to: "#\u6D4F\u89C8\u5668\u5382\u5546\u524D\u7F00" }, {
                default: withCtx(() => [
                  _hoisted_4
                ]),
                _: 1
        ...
        createBaseVNode("li", null, [
          createVNode(_component_RouterLink, { to: "#\u5C5E\u6027\u5185\u987A\u5E8F" }, {
            default: withCtx(() => [
              _hoisted_5
            ]),
            _: 1
          ...
          createBaseVNode("ul", null, [
            createBaseVNode("li", null, [
              createVNode(_component_RouterLink, { to: "#background-\u5C5E\u6027\u7B80\u5199" }, {
                default: withCtx(() => [
                  _hoisted_6
                ]),
                _: 1
            ...
            createBaseVNode("li", null, [
              createVNode(_component_RouterLink, { to: "#animation" }, {
                default: withCtx(() => [
                  _hoisted_7
                ]),
                _: 1
...
var propertiesOrder_html = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export { propertiesOrder_html as default };
