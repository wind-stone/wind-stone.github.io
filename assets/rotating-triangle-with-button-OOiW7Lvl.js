...
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "rotating-triangle-with-button",
...
const _hoisted_1 = { class: "rotating-triangle" };
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    _cache[0] || (_cache[0] = createBaseVNode("canvas", {
      id: "webgl",
      width: "400",
      height: "400"
...
const rotatingTriangleWithButton = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "rotating-triangle-with-button.vue"]]);
export {
  rotatingTriangleWithButton as default
};
