...
const data = JSON.parse('{"path":"/front-end-engineering/development/server-node/commonjs.html","title":"CommonJS 规范及实现","lang":"en-US","frontmatter":{"description":"CommonJS 规范及实现 包规范的实现 - NPM NPM 是 CommonJS 包规范的一种实现。 CommonJS 包规范的目录 package.json：包描述文件 bin：用于存放可执行二进制文件的目录 lib：用于存放 JavaScript 代码的目录 doc：用于存放文档的目录 test：用于存放单元测试用例的代码 安装依赖包 全局安装...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/front-end-engineering/development/server-node/commonjs.html"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"CommonJS 规范及实现"}],["meta",{"property":"og:description","content":"CommonJS 规范及实现 包规范的实现 - NPM NPM 是 CommonJS 包规范的一种实现。 CommonJS 包规范的目录 package.json：包描述文件 bin：用于存放可执行二进制文件的目录 lib：用于存放 JavaScript 代码的目录 doc：用于存放文档的目录 test：用于存放单元测试用例的代码 安装依赖包 全局安装..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2021-12-22T06:23:30.000Z"}],["meta",{"property":"article:modified_time","content":"2021-12-22T06:23:30.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"CommonJS 规范及实现\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2021-12-22T06:23:30.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"包规范的实现 - NPM","slug":"包规范的实现-npm","link":"#包规范的实现-npm","children":[{"level":3,"title":"CommonJS 包规范的目录","slug":"commonjs-包规范的目录","link":"#commonjs-包规范的目录","children":[]},{"level":3,"title":"安装依赖包","slug":"安装依赖包","link":"#安装依赖包","children":[]}]},{"level":2,"title":"模块规范的实现","slug":"模块规范的实现","link":"#模块规范的实现","children":[{"level":3,"title":"自定义模块的路径分析及文件定位","slug":"自定义模块的路径分析及文件定位","link":"#自定义模块的路径分析及文件定位","children":[]},{"level":3,"title":"require.resolve","slug":"require-resolve","link":"#require-resolve","children":[]}]}],"git":{"createdTime":1534950405000,"updatedTime":1640154210000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":2.78,"words":833},"filePathRelative":"front-end-engineering/development/server-node/commonjs.md","localizedDate":"August 22, 2018","autoDesc":true}');
export {
