...
const data = JSON.parse('{"path":"/frontend-fundamentals/css/preprocessor/stylus.html","title":"stylus 重点","lang":"en-US","frontmatter":{"description":"stylus 重点 选择器 不仅可以引用父选择器，还可以通过^[N]引用整个选择器链上的任意选择器。 ~/相当于^[0] 相对引用../ 根应用/ 内置函数selector()获取当前编译的选择器 内置函数selectors()获取在当前层级的嵌套选择器列表，以逗号分隔 变量 变量的值里可以包含其他变量 通常在标志符前加个$字符，来表示变量 插值 插值...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/css/preprocessor/stylus.html"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"stylus 重点"}],["meta",{"property":"og:description","content":"stylus 重点 选择器 不仅可以引用父选择器，还可以通过^[N]引用整个选择器链上的任意选择器。 ~/相当于^[0] 相对引用../ 根应用/ 内置函数selector()获取当前编译的选择器 内置函数selectors()获取在当前层级的嵌套选择器列表，以逗号分隔 变量 变量的值里可以包含其他变量 通常在标志符前加个$字符，来表示变量 插值 插值..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T10:17:02.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T10:17:02.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"stylus 重点\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T10:17:02.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"选择器","slug":"选择器","link":"#选择器","children":[]},{"level":2,"title":"变量","slug":"变量","link":"#变量","children":[]},{"level":2,"title":"插值","slug":"插值","link":"#插值","children":[]},{"level":2,"title":"运算符","slug":"运算符","link":"#运算符","children":[{"level":3,"title":"常规支持的运算符","slug":"常规支持的运算符","link":"#常规支持的运算符","children":[]},{"level":3,"title":"%","slug":"","link":"#","children":[]}]},{"level":2,"title":"mixin","slug":"mixin","link":"#mixin","children":[]},{"level":2,"title":"函数","slug":"函数","link":"#函数","children":[]}],"git":{"createdTime":1596805121000,"updatedTime":1779531422000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":1.01,"words":304},"filePathRelative":"frontend-fundamentals/css/preprocessor/stylus.md","localizedDate":"August 7, 2020","autoDesc":true}');
export {
  stylus_html as comp,
  data
};
