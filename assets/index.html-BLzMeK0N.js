  ...
  return openBlock(), createElementBlock("div", null, [
    _cache[7] || (_cache[7] = createBaseVNode("h1", {
      ...
      createBaseVNode("a", {
        ...
        createBaseVNode("span", null, "解题思路")
      ])
    ], -1)),
...
const data = JSON.parse('{"path":"/interview/algorithm/interview/binary-search/","title":"解题思路","lang":"en-US","frontmatter":{"description":"解题思路 关注点 搜索区间 明确搜索的区间是左闭右闭区间[left, right]，还是左闭右开区间[left, right)。 强烈推荐 在分析搜索区间时，将搜索区间尽量转变成左闭右闭区间[left, right]，这种形式是最直观的。 明确新的 left/right 根据中间位置元素的值nums[mid]可以把待搜索区间分为两个部分： 一定不存在 ...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/interview/algorithm/interview/binary-search/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"解题思路"}],["meta",{"property":"og:description","content":"解题思路 关注点 搜索区间 明确搜索的区间是左闭右闭区间[left, right]，还是左闭右开区间[left, right)。 强烈推荐 在分析搜索区间时，将搜索区间尽量转变成左闭右闭区间[left, right]，这种形式是最直观的。 明确新的 left/right 根据中间位置元素的值nums[mid]可以把待搜索区间分为两个部分： 一定不存在 ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-11T08:39:01.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-11T08:39:01.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"解题思路\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-11T08:39:01.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"关注点","slug":"关注点","link":"#关注点","children":[{"level":3,"title":"搜索区间","slug":"搜索区间","link":"#搜索区间","children":[]},{"level":3,"title":"明确新的 left/right","slug":"明确新的-left-right","link":"#明确新的-left-right","children":[]},{"level":3,"title":"循环判断条件","slug":"循环判断条件","link":"#循环判断条件","children":[]},{"level":3,"title":"返回 left/right","slug":"返回-left-right","link":"#返回-left-right","children":[]},{"level":3,"title":"mid 是上取整还是下取整","slug":"mid-是上取整还是下取整","link":"#mid-是上取整还是下取整","children":[]}]},{"level":2,"title":"参考文档","slug":"参考文档","link":"#参考文档","children":[]}],"git":{"createdTime":1618814080000,"updatedTime":1778488741000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":2.66,"words":798},"filePathRelative":"interview/algorithm/interview/binary-search/README.md","localizedDate":"April 19, 2021","autoDesc":true}');
export {
  index_html as comp,
  data
};
