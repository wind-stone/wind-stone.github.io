...
const data = JSON.parse('{"path":"/frontend-fundamentals/js/execution-mechanism/this.html","title":"this","lang":"en-US","frontmatter":{"description":"this 函数有哪几种调用方式可以导致 this 不同？ 作为普通函数调用 作为方法调用 作为构造函数调用 通过apply、call、bind显示绑定this进行调用 箭头函数 作为普通函数调用 在严格模式下声明的函数，this会绑定到undefined上 在非严格模式下声明的函数，this会绑定到window（或global）上 new fn() 的...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/js/execution-mechanism/this.html"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"this"}],["meta",{"property":"og:description","content":"this 函数有哪几种调用方式可以导致 this 不同？ 作为普通函数调用 作为方法调用 作为构造函数调用 通过apply、call、bind显示绑定this进行调用 箭头函数 作为普通函数调用 在严格模式下声明的函数，this会绑定到undefined上 在非严格模式下声明的函数，this会绑定到window（或global）上 new fn() 的..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T10:17:02.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T10:17:02.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"this\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T10:17:02.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"函数有哪几种调用方式可以导致 this 不同？","slug":"函数有哪几种调用方式可以导致-this-不同","link":"#函数有哪几种调用方式可以导致-this-不同","children":[]},{"level":2,"title":"作为普通函数调用","slug":"作为普通函数调用","link":"#作为普通函数调用","children":[]},{"level":2,"title":"new fn() 的过程","slug":"new-fn-的过程","link":"#new-fn-的过程","children":[]},{"level":2,"title":"apply 和 call 方法","slug":"apply-和-call-方法","link":"#apply-和-call-方法","children":[{"level":3,"title":"apply 与 call 的区别","slug":"apply-与-call-的区别","link":"#apply-与-call-的区别","children":[]},{"level":3,"title":"性能对比","slug":"性能对比","link":"#性能对比","children":[]},{"level":3,"title":"常用示例","slug":"常用示例","link":"#常用示例","children":[]}]}],"git":{"createdTime":1533973348000,"updatedTime":1779531422000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":1.39,"words":416},"filePathRelative":"frontend-fundamentals/js/execution-mechanism/this.md","localizedDate":"August 11, 2018","autoDesc":true}');
export {
  this_html as comp,
  data
};
