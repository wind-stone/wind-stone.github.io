...
const data = JSON.parse('{"path":"/frontend-fundamentals/code-snippet/js/","title":"工具函数","lang":"en-US","frontmatter":{"description":"工具函数 生成随机的字母数字字符串 说明：Number 的toString()方法接受一个表示基数的参数，告诉它返回几进制数值的字符串形式。","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/code-snippet/js/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"工具函数"}],["meta",{"property":"og:description","content":"工具函数 生成随机的字母数字字符串 说明：Number 的toString()方法接受一个表示基数的参数，告诉它返回几进制数值的字符串形式。"}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T10:17:02.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T10:17:02.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"工具函数\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T10:17:02.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"生成随机的字母数字字符串","slug":"生成随机的字母数字字符串","link":"#生成随机的字母数字字符串","children":[]}],"git":{"createdTime":1533973348000,"updatedTime":1779531422000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":0.24,"words":73},"filePathRelative":"frontend-fundamentals/code-snippet/js/README.md","localizedDate":"August 11, 2018","autoDesc":true}');
export {
  index_html as comp,
  data
};
