...
const data = JSON.parse('{"path":"/frontend-fundamentals/js/unclassified/","title":"未分类内容","lang":"en-US","frontmatter":{"description":"未分类内容 编写原生 JavaScript 插件 插件需要满足的条件 一个可复用的插件需要满足以下条件： 插件自身的作用域与用户当前的作用域相互独立，也就是插件内部的私有变量不能影响使用者的环境变量； 插件需具备默认设置参数； 插件除了具备已实现的基本功能外，需提供部分API，使用者可以通过该API修改插件功能的默认参数，从而实现用户自定义插件效果； ...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/js/unclassified/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"未分类内容"}],["meta",{"property":"og:description","content":"未分类内容 编写原生 JavaScript 插件 插件需要满足的条件 一个可复用的插件需要满足以下条件： 插件自身的作用域与用户当前的作用域相互独立，也就是插件内部的私有变量不能影响使用者的环境变量； 插件需具备默认设置参数； 插件除了具备已实现的基本功能外，需提供部分API，使用者可以通过该API修改插件功能的默认参数，从而实现用户自定义插件效果； ..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T10:17:02.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T10:17:02.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"未分类内容\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T10:17:02.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"编写原生 JavaScript 插件","slug":"编写原生-javascript-插件","link":"#编写原生-javascript-插件","children":[{"level":3,"title":"插件需要满足的条件","slug":"插件需要满足的条件","link":"#插件需要满足的条件","children":[]}]}],"git":{"createdTime":1623668328000,"updatedTime":1779531422000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":0.75,"words":224},"filePathRelative":"frontend-fundamentals/js/unclassified/README.md","localizedDate":"June 14, 2021","autoDesc":true}');
export {
  index_html as comp,
  data
};
