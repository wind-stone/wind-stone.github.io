...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      ...
      createVNode(_component_RouteLink, { to: "/frontend-fundamentals/js/data-types/number/floating.html" }, {
...
const data = JSON.parse('{"path":"/frontend-fundamentals/js/data-types/number/","title":"Number","lang":"en-US","frontmatter":{"description":"Number JavaScript 至今没有真正的整数，我们用的Number事实上是双精度浮点数，详见。 精度问题 精度问题，可以先看了解浮点数的实现。 parseInt(0.0000008) === 8 parseInt 的第一个类型是字符串，所以会将传入的参数转换成字符串，但是小于0.0000001（1e-7）的数字转换成 String 时，会变成...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/js/data-types/number/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"Number"}],["meta",{"property":"og:description","content":"Number JavaScript 至今没有真正的整数，我们用的Number事实上是双精度浮点数，详见。 精度问题 精度问题，可以先看了解浮点数的实现。 parseInt(0.0000008) === 8 parseInt 的第一个类型是字符串，所以会将传入的参数转换成字符串，但是小于0.0000001（1e-7）的数字转换成 String 时，会变成..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T10:17:02.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T10:17:02.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"Number\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T10:17:02.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"精度问题","slug":"精度问题","link":"#精度问题","children":[{"level":3,"title":"parseInt(0.0000008) === 8","slug":"parseint-0-0000008-8","link":"#parseint-0-0000008-8","children":[]},{"level":3,"title":"0.1 + 0.2 = 0.3","slug":"_0-1-0-2-0-3","link":"#_0-1-0-2-0-3","children":[]},{"level":3,"title":"toFixed 的结果不精确","slug":"tofixed-的结果不精确","link":"#tofixed-的结果不精确","children":[]}]},{"level":2,"title":"关于 3.toString()","slug":"关于-3-tostring","link":"#关于-3-tostring","children":[]}],"git":{"createdTime":1539744302000,"updatedTime":1779531422000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":1.84,"words":552},"filePathRelative":"frontend-fundamentals/js/data-types/number/README.md","localizedDate":"October 17, 2018","autoDesc":true}');
export {
  index_html as comp,
  data
};
