...
const data = JSON.parse('{"path":"/frontend-fundamentals/es6/let-const/","title":"let 和 const","lang":"en-US","frontmatter":{"description":"let 和 const let 命令 不存在变量提升，只能先声明后使用 暂时性死区 不允许重复声明 for的父子作用域 for循环还有一个特别之处，就是设置循环变量的那部分是一个父作用域，而循环体内部是一个单独的子作用域。 上面代码正确运行，输出了 3 次abc。这表明函数内部的变量i与循环变量i不在同一个作用域，有各自单独的作用域。 块级作用域 块级...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/es6/let-const/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"let 和 const"}],["meta",{"property":"og:description","content":"let 和 const let 命令 不存在变量提升，只能先声明后使用 暂时性死区 不允许重复声明 for的父子作用域 for循环还有一个特别之处，就是设置循环变量的那部分是一个父作用域，而循环体内部是一个单独的子作用域。 上面代码正确运行，输出了 3 次abc。这表明函数内部的变量i与循环变量i不在同一个作用域，有各自单独的作用域。 块级作用域 块级..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T10:17:02.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T10:17:02.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"let 和 const\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T10:17:02.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"let 命令","slug":"let-命令","link":"#let-命令","children":[]},{"level":2,"title":"块级作用域","slug":"块级作用域","link":"#块级作用域","children":[{"level":3,"title":"哪些语句会产生块级作用域","slug":"哪些语句会产生块级作用域","link":"#哪些语句会产生块级作用域","children":[]}]},{"level":2,"title":"const 命令","slug":"const-命令","link":"#const-命令","children":[]},{"level":2,"title":"ES6 声明变量的六种方法","slug":"es6-声明变量的六种方法","link":"#es6-声明变量的六种方法","children":[]},{"level":2,"title":"顶层对象的属性","slug":"顶层对象的属性","link":"#顶层对象的属性","children":[]},{"level":2,"title":"global 对象","slug":"global-对象","link":"#global-对象","children":[]}],"git":{"createdTime":1521035369000,"updatedTime":1779531422000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":3.58,"words":1073},"filePathRelative":"frontend-fundamentals/es6/let-const/README.md","localizedDate":"March 14, 2018","autoDesc":true}');
export {
  index_html as comp,
  data
};
