import { r as resolveComponent, c as createElementBlock, d as createBaseVNode, a as createVNode, e as withCtx, f as createTextVNode, b as createStaticVNode, o as openBlock } from "./app-CJaEk_oZ.js";
...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      ...
      createVNode(_component_RouteLink, { to: "/front-end-engineering/development/npm/npm-config.html" }, {
...
const data = JSON.parse('{"path":"/front-end-engineering/development/npm/npmrc.html","title":"npmrc","lang":"en-US","frontmatter":{"description":"npmrc 描述 npm会从命令行、环境变量和.npmrc文件里获取配置信息。 npm config命令用于更新和编辑用户及全局.npmrc文件的内容。 所有可用配置的选项，可见。 .npmrc文件，就是npm的配置文件所在位置。我们可以找到.npmrc文件，以修改各个配置项。 文件 这里有四个相关的文件（PS：按优先级从高到底排序）： 每个项目的配置...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/front-end-engineering/development/npm/npmrc.html"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"npmrc"}],["meta",{"property":"og:description","content":"npmrc 描述 npm会从命令行、环境变量和.npmrc文件里获取配置信息。 npm config命令用于更新和编辑用户及全局.npmrc文件的内容。 所有可用配置的选项，可见。 .npmrc文件，就是npm的配置文件所在位置。我们可以找到.npmrc文件，以修改各个配置项。 文件 这里有四个相关的文件（PS：按优先级从高到底排序）： 每个项目的配置..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2021-12-22T06:23:30.000Z"}],["meta",{"property":"article:modified_time","content":"2021-12-22T06:23:30.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"npmrc\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2021-12-22T06:23:30.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"描述","slug":"描述","link":"#描述","children":[]},{"level":2,"title":"文件","slug":"文件","link":"#文件","children":[]},{"level":2,"title":"注释","slug":"注释","link":"#注释","children":[]},{"level":2,"title":"每个项目的配置文件","slug":"每个项目的配置文件","link":"#每个项目的配置文件","children":[]},{"level":2,"title":"每个用户的配置文件","slug":"每个用户的配置文件","link":"#每个用户的配置文件","children":[]},{"level":2,"title":"全局配置文件","slug":"全局配置文件","link":"#全局配置文件","children":[]},{"level":2,"title":"内置的配置文件","slug":"内置的配置文件","link":"#内置的配置文件","children":[]}],"git":{"createdTime":1570275215000,"updatedTime":1640154210000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":2.16,"words":649},"filePathRelative":"front-end-engineering/development/npm/npmrc.md","localizedDate":"October 5, 2019","autoDesc":true}');
export {
  npmrc_html as comp,
  data
};
