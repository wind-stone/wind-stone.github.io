...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("p", null, [
      createVNode(_component_RouteLink, { to: "/frontend-fundamentals/frontend-engineering/tools/style-guide/code-formatter/eslint/prettier-eslint.html" }, {
...
const data = JSON.parse('{"path":"/frontend-fundamentals/frontend-engineering/tools/style-guide/code-formatter/eslint/","title":"ESLint","lang":"en-US","frontmatter":{"description":"ESLint 参考 & 引用文档 ESLint 中文官方文档 规则 规则配置 off或0 - 关闭规则 warn或1 - 开启规则，使用警告级别的错误：warn(不会导致程序退出) error或2 - 开启规则，使用错误级别的错误：error(当被触发的时候，程序会退出) Reference: Configuring Rules 行内方式关闭规则 ES...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/frontend-fundamentals/frontend-engineering/tools/style-guide/code-formatter/eslint/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"ESLint"}],["meta",{"property":"og:description","content":"ESLint 参考 & 引用文档 ESLint 中文官方文档 规则 规则配置 off或0 - 关闭规则 warn或1 - 开启规则，使用警告级别的错误：warn(不会导致程序退出) error或2 - 开启规则，使用错误级别的错误：error(当被触发的时候，程序会退出) Reference: Configuring Rules 行内方式关闭规则 ES..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2026-05-23T11:16:03.000Z"}],["meta",{"property":"article:modified_time","content":"2026-05-23T11:16:03.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"ESLint\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2026-05-23T11:16:03.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"规则","slug":"规则","link":"#规则","children":[{"level":3,"title":"规则配置","slug":"规则配置","link":"#规则配置","children":[]},{"level":3,"title":"行内方式关闭规则","slug":"行内方式关闭规则","link":"#行内方式关闭规则","children":[]}]},{"level":2,"title":"ESLint 插件和配置","slug":"eslint-插件和配置","link":"#eslint-插件和配置","children":[{"level":3,"title":"Vue 相关","slug":"vue-相关","link":"#vue-相关","children":[]},{"level":3,"title":"与 Prettier 的集成","slug":"与-prettier-的集成","link":"#与-prettier-的集成","children":[]}]},{"level":2,"title":"集成","slug":"集成","link":"#集成","children":[{"level":3,"title":"源码控制","slug":"源码控制","link":"#源码控制","children":[]}]}],"git":{"createdTime":1570275089000,"updatedTime":1779534963000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":1}]},"readingTime":{"minutes":1.13,"words":340},"filePathRelative":"frontend-fundamentals/frontend-engineering/tools/style-guide/code-formatter/eslint/index.md","localizedDate":"October 5, 2019","autoDesc":true}');
export {
  index_html as comp,
  data
};
