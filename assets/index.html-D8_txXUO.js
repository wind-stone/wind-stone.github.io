...
function _sfc_render(_ctx, _cache) {
  ...
  return openBlock(), createElementBlock("div", null, [
    ...
    createBaseVNode("ul", null, [
      createBaseVNode("li", null, [
        createVNode(_component_RouteLink, { to: "/front-end-engineering/development/h5/style.html" }, {
      ...
      createBaseVNode("li", null, [
        createVNode(_component_RouteLink, { to: "/front-end-engineering/development/h5/format.html" }, {
...
const data = JSON.parse('{"path":"/front-end-engineering/development/h5/","title":"注意事项","lang":"en-US","frontmatter":{"description":"注意事项 实现阶段 金额 金额单位 涉及到金额的地方，尤其是需要前端进行计算的场景，金额一定要使用分为单位，而不能使用元。 控制按钮点击频率/事件回调调用频率 防爆击，使用lodash.throttle进行节流处理 防止频繁触发事件回调，使用lodash.debounce进行防抖动处理 活动类项目注意事项 活动阶段变更 若活动存在未开始、进行中、已结束...","head":[["meta",{"property":"og:url","content":"https://blog.windstone.cc/front-end-engineering/development/h5/"}],["meta",{"property":"og:site_name","content":"风动之石的博客"}],["meta",{"property":"og:title","content":"注意事项"}],["meta",{"property":"og:description","content":"注意事项 实现阶段 金额 金额单位 涉及到金额的地方，尤其是需要前端进行计算的场景，金额一定要使用分为单位，而不能使用元。 控制按钮点击频率/事件回调调用频率 防爆击，使用lodash.throttle进行节流处理 防止频繁触发事件回调，使用lodash.debounce进行防抖动处理 活动类项目注意事项 活动阶段变更 若活动存在未开始、进行中、已结束..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:locale","content":"en-US"}],["meta",{"property":"og:updated_time","content":"2021-12-29T07:32:49.000Z"}],["meta",{"property":"article:modified_time","content":"2021-12-29T07:32:49.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"注意事项\\",\\"image\\":[\\"\\"],\\"dateModified\\":\\"2021-12-29T07:32:49.000Z\\",\\"author\\":[]}"]]},"headers":[{"level":2,"title":"实现阶段","slug":"实现阶段","link":"#实现阶段","children":[{"level":3,"title":"金额","slug":"金额","link":"#金额","children":[]},{"level":3,"title":"控制按钮点击频率/事件回调调用频率","slug":"控制按钮点击频率-事件回调调用频率","link":"#控制按钮点击频率-事件回调调用频率","children":[]}]},{"level":2,"title":"活动类项目注意事项","slug":"活动类项目注意事项","link":"#活动类项目注意事项","children":[{"level":3,"title":"活动阶段变更","slug":"活动阶段变更","link":"#活动阶段变更","children":[]}]},{"level":2,"title":"业务监控","slug":"业务监控","link":"#业务监控","children":[]},{"level":2,"title":"纯前端实现最佳实践","slug":"纯前端实现最佳实践","link":"#纯前端实现最佳实践","children":[]},{"level":2,"title":"性能优化","slug":"性能优化","link":"#性能优化","children":[]},{"level":2,"title":"坑","slug":"坑","link":"#坑","children":[]}],"git":{"createdTime":1576291184000,"updatedTime":1640763169000,"contributors":[{"name":"wind-stone","email":"wind-stone@qq.com","commits":3}]},"readingTime":{"minutes":2.16,"words":649},"filePathRelative":"front-end-engineering/development/h5/index.md","localizedDate":"December 14, 2019","autoDesc":true}');
export {
  index_html as comp,
  data
};
